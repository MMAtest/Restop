...
FRONTEND_BACKEND_URL = "https://easy-resto-1.preview.emergentagent.com"
...
class FrontendAPITest:
    ...
    def test_frontend_backend_connectivity(self):
        ...
        headers = {
            ...
            'Origin': 'https://easy-resto-1.preview.emergentagent.com',  # Simulate frontend origin
            'Referer': 'https://easy-resto-1.preview.emergentagent.com/'
        }
    ...
    def test_preflight_requests(self):
        ...
        headers = {
            'Origin': 'https://easy-resto-1.preview.emergentagent.com',
