...
FRONTEND_BACKEND_URL = "https://cuisine-tracker-5.preview.emergentagent.com"
...
class FrontendAPITest:
    ...
    def test_frontend_backend_connectivity(self):
        ...
        headers = {
            ...
            'Origin': 'https://cuisine-tracker-5.preview.emergentagent.com',  # Simulate frontend origin
            'Referer': 'https://cuisine-tracker-5.preview.emergentagent.com/'
        }
    ...
    def test_preflight_requests(self):
        ...
        headers = {
            'Origin': 'https://cuisine-tracker-5.preview.emergentagent.com',
    ...
    def test_axios_simulation(self):
        ...
        try:
            ...
            BACKEND_URL = "https://cuisine-tracker-5.preview.emergentagent.com"
