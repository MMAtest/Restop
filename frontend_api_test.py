...
FRONTEND_BACKEND_URL = "https://cuisinepro.preview.emergentagent.com"
...
class FrontendAPITest:
    ...
    def test_frontend_backend_connectivity(self):
        ...
        headers = {
            ...
            'Origin': 'https://cuisinepro.preview.emergentagent.com',  # Simulate frontend origin
            'Referer': 'https://cuisinepro.preview.emergentagent.com/'
        }
    ...
    def test_preflight_requests(self):
        ...
        headers = {
            'Origin': 'https://cuisinepro.preview.emergentagent.com',
