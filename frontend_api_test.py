...
FRONTEND_BACKEND_URL = "https://receipt-scanner-64.preview.emergentagent.com"
...
class FrontendAPITest:
    ...
    def test_frontend_backend_connectivity(self):
        ...
        headers = {
            ...
            'Origin': 'https://receipt-scanner-64.preview.emergentagent.com',  # Simulate frontend origin
            'Referer': 'https://receipt-scanner-64.preview.emergentagent.com/'
        }
    ...
    def test_preflight_requests(self):
        ...
        headers = {
            'Origin': 'https://receipt-scanner-64.preview.emergentagent.com',
