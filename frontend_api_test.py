...
FRONTEND_BACKEND_URL = "https://rest-mgmt-sys.preview.emergentagent.com"
...
class FrontendAPITest:
    ...
    def test_frontend_backend_connectivity(self):
        ...
        headers = {
            ...
            'Origin': 'https://rest-mgmt-sys.preview.emergentagent.com',  # Simulate frontend origin
            'Referer': 'https://rest-mgmt-sys.preview.emergentagent.com/'
        }
    ...
    def test_preflight_requests(self):
        ...
        headers = {
            'Origin': 'https://rest-mgmt-sys.preview.emergentagent.com',
