...
function App() {
  ...
  const [showDemoData, setShowDemoData] = useState(false); // Ne pas afficher les données de démo par défaut
  ...
  // États pour les stocks critiques
    ...
    <>
      ...
      <div className="content-wrapper">
        <div id="dashboard" className={`wireframe-section ${activeTab === "dashboard" ? "active" : ""}`}>
          ...
          {currentUser?.role !== 'employe_cuisine' && currentUser?.role !== 'barman' && currentUser?.role !== 'caissier' && (
            ...
            <div className="section-card">
              ...
              {/* KPIs Ventes - TOUJOURS AFFICHÉS (données réelles ou 0) */}
          ...
          {activeDashboardTab === "alertes" && (
            <div className="section-card">
              ...
              {/* Nouvelle section séparée : DLC Critiques - EN MODE DÉMO */}
              {showDemoData && (
              <div className="alert-section">
              ...
              {/* Section DLC < 3 jours - EN MODE DÉMO */}
              {showDemoData && (
              <div className="alert-section">
                <div className="alert-header" style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                  <div style={{display: 'flex', alignItems: 'center'}}>
              ...
              {/* Section DLC < 7 jours - EN MODE DÉMO */}
              {showDemoData && (
              <div className="alert-section">
                <div className="alert-header" style={{display: 'flex', alignItems: 'center', justifyContent: 'space-between'}}>
                  <div style={{display: 'flex', alignItems: 'center'}}>
              ...
              <div className="section-card">
                ...
                {activeOcrTab === 'factures' && (
                  <div className="item-list">
                    ...
                    {(() => {
                      // Filtrer seulement les factures INTÉGRÉES
                      const filteredDocs = documentsOcr.filter(doc => 
                        doc.type_document === 'facture_fournisseur' && 
                        doc.statut === 'integre'
                      );
        ...
        {/* PRODUCTION - avec Historique */}
          ...
          setProduitsParCategories={setProduitsParCategories}
          categoriesExpanded={categoriesExpanded}
          setCategoriesExpanded={setCategoriesExpanded}
          canEditItems={canEditItems}
          handleEdit={handleEdit}
          canArchiveItems={canArchiveItems}
          ...
          deleteArchivePermanently={deleteArchivePermanently}
          ...
          filterRecettesByCategory={filterRecettesByCategory}
          ...
          handlePreparationSubmit={handlePreparationSubmit}
          resetPreparationForm={resetPreparationForm}
          calculatePerte={calculatePerte}
          calculatePortions={calculatePortions}
          formesDecoupe={formesDecoupe}
          stocksPreparations={stocksPreparations}
          mouvementsPreparations={mouvementsPreparations}
          showMovementPreparationModal={showMovementPreparationModal}
          setShowMovementPreparationModal={setShowMovementPreparationModal}
          movementPreparationForm={movementPreparationForm}
          preparationsParCategories={preparationsParCategories}
          categoriesPreparationsExpanded={categoriesPreparationsExpanded}
          handleMovementPreparation={handleMovementPreparation}
          archivedItems={archivedItems}
          selectedArchiveType={selectedArchiveType}
          setSelectedArchiveType={setSelectedArchiveType}
          filterProduitsByCategory={filterProduitsByCategory}
          canCreateItems={canCreateItems}
          setPreparationForm={setPreparationForm}
          setMovementPreparationForm={setMovementPreparationForm}
          setCategoriesPreparationsExpanded={setCategoriesPreparationsExpanded}
          recettes={recettes}
